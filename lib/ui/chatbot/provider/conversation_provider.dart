...
final conversationMessagesProvider = FutureProvider.family<List<MessageModel>, String>(
...
final conversationMessagesNotifierProvider = AsyncNotifierProvider.family<
    ConversationMessagesNotifier,
    List<MessageModel>,
    String>(
  (conversationId) => ConversationMessagesNotifier()..setConversationId(conversationId),
);
