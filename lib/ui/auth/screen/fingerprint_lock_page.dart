...
class FingerprintLockPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<FingerprintLockPage> createState() => _FingerprintLockPageState();
}
...
class _FingerprintLockPageState extends ConsumerState<FingerprintLockPage> {
  ...
  Future<void> _startAuth() async {
    ...
    try {
      ...
      setState(() { _message = 'Authenticated, restoring session...'; });
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                _authInProgress ? 'Waiting for fingerprint...' : (_message ?? 'Place your finger on the sensor'),
